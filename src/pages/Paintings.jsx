...
const paintingsData = [
  ...
  { id: 8, category: "waetrcolor", name: "Scenery painting", description: "A watercolor landscape painting", src: require("../assets/watercolor2.jpeg") },
  ...
  { id: 11, category: "acylic", name: "Where have you been?", description: "An Acrylic painting of a sunset", src: require("../assets/acrylic3.jpeg") },
  { id: 12, category: "acylic", name: "Acrylic Scenery painting", description: "An Acrylic painting of a orest", src: require("../assets/acrylic4.jpeg") },
  ...
  { id: 14, category: "card", name: "Birthday Card", description: "A birthday card with a watercolor painting of flowers", src: require("../assets/card2.jpeg") },
  { id: 15, category: "acylic", name: "Landscape painting", description: "An Acrylic painting of a sunset", src: require("../assets/acrylic5.jpeg") },
  { id: 16, category: "waetrcolor", name: "Don't tease me", description: "A watercolor painting of a woman with emotions", src: require("../assets/watercolor3.jpeg") },
  { id: 17, category: "acylic", name: "Sally and Lily", description: "An Acrylic painting of two lovely pets", src: require("../assets/acrylic6.jpeg") },
  ...
  { id: 20, category: "cards", name: "Anniversery Cards", description: "Handmade card with Acryclic Painting for anniversery", src: require("../assets/card3.jpeg") },
  ...
  { id: 22, category: "cards", name: "Chistmas Greetings", description: "Handmade card with watercolor for Christmas", src: require("../assets/card5.jpeg") },
  ...
  { id: 25, category: "acylic", name: "Scenery Painting on a log", description: "An Acrylic landscape painting", src: require("../assets/acrylic9.jpeg") },
  { id: 26, category: "acylic", name: "Serendib Scops Owl", description: "An Acrylic scenery painting of Serendib Scops Owls", src: require("../assets/acrylic7.jpeg") },
  { id: 27, category: "acylic", name: "Sri Lanka Dull Blue Flycatcher", description: "An Acrylic scenery painting of Sri Lanka Dull Blue Flycatchers", src: require("../assets/acrylic8.jpeg") },
  ...
  { id: 33, category: "acylic", name: "Sunset through the cave", description: "An Acrylic scenery painting of the sunset", src: require("../assets/acrylic10.jpeg") },
  { id: 34, category: "acylic", name: "A sunset", description: "An Acrylic scenery painting of the sunset", src: require("../assets/acrylic11.jpeg") },
  ...
  { id: 38, category: "cards", name: "Anniversery Card", description: "Handmade card with Acrylic for a couple", src: require("../assets/card9.jpeg") },
  ...
  { id: 40, category: "acylic", name: "At the end, the sun sets", description: "An Acrylic scenery painting of the sunset", src: require("../assets/acrylic12.jpeg") },
